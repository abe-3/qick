module tb_fifo_dc #(parameter B = 16, parameter N = 4) ();
    ...
    // VHDL Instantiation
    fifo_dc vhdl_dut    #(.B(B), .N(N)) (wr_rstn, wr_clk, rd_rstn, rd_clk, wr_en, din, rd_en, dout_vhdl, full_vhdl, empty_vhdl);

    // Translated System Verilog Instantiation
    fifo_dc_sv sv_dut   #(.B(B), .N(N)) (wr_rstn, wr_clk, rd_rstn, rd_clk, wr_en, din, rd_en, dout_sv, full_sv, empty_sv);
